...
import type { KpiTone, ShopKpi } from "./types";

const ICONS = {
  "package-clock": PackageCheck,
...
function KpiTile({ kpi, index }: { kpi: ShopKpi; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <p className="text-2xl font-extrabold text-kore-ink tabular-nums">
          {kpi.value}
        </p>
      </div>
