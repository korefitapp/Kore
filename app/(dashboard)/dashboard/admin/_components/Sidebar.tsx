...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[252px] flex-shrink-0 border-r border-kore-border bg-kore-card/60 backdrop-blur-sm">
      ...
      <div className="p-3 space-y-3">
        ...
        <div className="rounded-2xl border border-kore-border bg-kore-bg/60 p-3 flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-xl text-2xl grid place-items-center flex-shrink-0"
