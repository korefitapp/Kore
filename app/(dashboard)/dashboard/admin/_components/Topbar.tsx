...
import { Bell, Command, Search, ShieldAlert } from "lucide-react";
      ...
      <div className="h-16 px-6 flex items-center gap-4">
        <div className="relative flex-1 max-w-xl">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-16 rounded-xl bg-kore-bg border border-kore-border text-sm text-kore-ink placeholder:text-kore-muted focus:outline-none focus:border-kore-emerald/60 focus:ring-2 focus:ring-kore-emerald/15 transition"
          />
          <span className="absolute right-2.5 top-1/2 -translate-y-1/2 inline-flex items-center gap-1 text-[10px] font-bold text-kore-muted bg-kore-card border border-kore-border rounded-md px-1.5 py-0.5">
            <Command size={10} /> K
          </span>
        </div>
