...
function PagamentosTab() {
  ...
  const [consultationValue, setConsultationValue] = useState("189,00");
  const [saving, setSaving] = useState(false);
  const [saved, setSaved] = useState(false);
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-kore-border bg-kore-card/60 backdrop-blur-sm p-5">
        ...
        <p className="text-xs text-kore-muted mb-5">
          Conecte sua conta Stripe para receber pagamentos dos pacientes
        </p>
      ...
      <div className="rounded-2xl border border-kore-border bg-kore-card/60 backdrop-blur-sm p-5">
        ...
        <p className="text-xs text-kore-muted mb-5">
          Defina o valor cobrado por consulta avulsa. Este valor será aplicado como padrão ao criar novos agendamentos.
        </p>
        <div className="max-w-xs">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="0,00"
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-kore-bg border border-kore-border text-sm font-medium text-kore-ink placeholder-kore-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 transition"
            />
          </div>
        </div>
      </div>
