    ...
    >
      ...
      {weight && height && (
        <motion.section
          ...
          className="rounded-3xl border border-kore bg-kore-card p-5 shadow-sm mt-5"
        >
      ...
      <button
        onClick={handleSave}
        className="w-full mt-5 rounded-3xl bg-emerald-500 hover:brightness-105 text-white font-bold py-3.5 flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/30 active:scale-[0.98] transition"
      >
        <Save size={18} />
